package com.rustamsaga.onboarding_presentation.nutrient_goal
...
import com.rustamsaga.onboarding_presentation.components.UnitTextField
    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(NutrientGoalEvent.OnCardRatioEnter(it))
                },
